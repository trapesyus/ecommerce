...
{
    public class UrunlerKupeController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public UrunlerKupeController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult UrunlerKupe()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("UrunlerKupe", "UrunlerKupe");
                }
                else
                {
