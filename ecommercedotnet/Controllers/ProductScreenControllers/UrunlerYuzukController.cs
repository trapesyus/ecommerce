...
{
    public class UrunlerYuzukController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public UrunlerYuzukController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult UrunlerYuzuk()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("UrunlerYuzuk", "UrunlerYuzuk");
                }
                else
                {
