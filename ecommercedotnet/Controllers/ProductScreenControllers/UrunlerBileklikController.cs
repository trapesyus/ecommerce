...
{
    public class UrunlerBilekikController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public UrunlerBilekikController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult UrunlerBilekik()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("UrunlerBilekik", "UrunlerBilekik");
                }
                else
                {
