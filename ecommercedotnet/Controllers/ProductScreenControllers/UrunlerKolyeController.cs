...
{
    public class UrunlerKolyeController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public UrunlerKolyeController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult UrunlerKolye()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("UrunlerKolye", "UrunlerKolye");
                }
                else
                {
