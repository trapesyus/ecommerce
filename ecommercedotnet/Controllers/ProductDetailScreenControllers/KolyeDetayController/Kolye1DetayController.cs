...
{
    public class Kolye1DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Kolye1DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Kolye1Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Kolye1Detay", "Kolye1Detay");
                }
                else
                {
