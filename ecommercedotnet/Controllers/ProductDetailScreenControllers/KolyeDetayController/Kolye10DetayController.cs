...
namespace ecommercedotnet.Controllers.ProductDetailScreenControllers.KolyeDetayController
{
    public class Kolye10DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Kolye10DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Kolye10Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Kolye10Detay", "Kolye10Detay");
                }
                else
                {
