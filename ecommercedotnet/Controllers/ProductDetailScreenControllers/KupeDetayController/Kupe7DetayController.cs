...
{
    public class Kupe7DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Kupe7DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Kupe7Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Kupe7Detay", "Kupe7Detay");
                }
                else
                {
