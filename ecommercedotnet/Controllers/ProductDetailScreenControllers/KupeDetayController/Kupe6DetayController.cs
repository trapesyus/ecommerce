...
{
    public class Kupe6DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Kupe6DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Kupe6Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Kupe6Detay", "Kupe6Detay");
                }
                else
                {
