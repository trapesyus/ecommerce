...
namespace ecommercedotnet.Controllers.ProductDetailScreenControllers.KupeDetayController
{
    public class Kupe4DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Kupe4DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Kupe4Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Kupe4Detay", "Kupe4Detay");
                }
                else
                {
