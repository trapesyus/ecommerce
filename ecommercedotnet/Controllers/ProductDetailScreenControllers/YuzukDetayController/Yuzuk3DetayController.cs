...
namespace ecommercedotnet.Controllers.ProductDetailScreenControllers.YuzukDetayController
{
    public class Yuzuk3DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Yuzuk3DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Yuzuk3Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Yuzuk3Detay", "Yuzuk3Detay");
                }
                else
                {
