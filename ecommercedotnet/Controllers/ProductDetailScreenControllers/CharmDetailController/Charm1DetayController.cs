...
namespace ecommercedotnet.Controllers.ProductDetailScreenControllers.CharmDetailController
{
    public class Charm1DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Charm1DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Charm1Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Charm1Detay", "Charm1Detay");
                }
                else
                {
