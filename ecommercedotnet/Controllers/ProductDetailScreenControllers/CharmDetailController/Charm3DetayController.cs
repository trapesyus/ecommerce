...
{
    public class Charm3DetayController : Controller
    {
        private readonly ILogger<HomeController> _logger;
        IUserService _userService;

        public Charm3DetayController(ILogger<HomeController> logger, IUserService userService)
        {
            _logger = logger;
            _userService = userService;
        }

        public IActionResult Charm3Detay()
        {
            return View();
        }
    ...
    // Diğer claim'ler
                    ...
                    return RedirectToAction("Charm3Detay", "Charm3Detay");
                }
                else
                {
